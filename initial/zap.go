...
import (
	...
	"battery_monitoring/initial/internal"
...
func (z *_zap) InitZap() {
	if ok, _ := utils.PathExists(global.C.Zap.Director); !ok { // 判断是否有Director文件夹
		fmt.Println(`创建文件夹成功, 文件夹名称为: `, global.C.Zap.Director)
		_ = os.Mkdir(global.C.Zap.Director, os.ModePerm)
	}
